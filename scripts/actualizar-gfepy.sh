...
# ------------------------------------------------------------------------------------------------------
v_ejecutable_instalador=GFEPY_unix_2_01_00.sh
v_carpeta_instaladores=/home/datalogic/INSTALADORES/
v_carpeta_configuracion_instalacion=/home/datalogic/ARCHIVOS_INSTALACIONES/gfepy.test-gfepy
v_ftp_usuario=cliente
v_ftp_password=cli.1717
v_ftp_carpeta_betas=GFE-PY/betas
...
curl --user datalogic:dlc/1840 http://gfepy.test.datalogic-software.com:8080/manager/text/reload?path=/gfepy
