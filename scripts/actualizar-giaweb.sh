...
echo "=== Recargando aplicaciones: "$v_apps_a_recargar
# Se carga un array con la lista de applicaiones a recargar, que vienen separadas por coma, para poder hacer el for.
